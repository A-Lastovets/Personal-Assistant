...
class UserViewTests(TestCase):
    ...
    #     user = UserModel.objects.create_user(username='testuser', password='testpassword123')
    #     profile, created = Profile.objects.get_or_create(user=user, defaults={'avatar': 'default_avatar.png'})
    #     self.client.login(username='testuser', password='testpassword123')

    #     uploaded_file = SimpleUploadedFile(
    #         'Updated.jpg', 
    #         b'test_image_content',  # This represents the file content
    ...
    #     self.assertEqual(profile.avatar.name.split('/')[-1], 'Updated.jpg')
    #     self.assertEqual(response.status_code, 302)  
