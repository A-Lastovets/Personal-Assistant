...
# Клас для фільтрації контактів за найближчими днями народження
    ...
    def queryset(self, request, queryset):
        ...
        if period is not None:
            ...
            for contact in queryset:
                ...
                # Перевіряємо, чи попадає день народження в обраний період
...
class ContactAdmin(admin.ModelAdmin):
    ...
    list_filter = (UpcomingBirthdaysFilter, 'birthday')  # Додаємо свій фільтр
